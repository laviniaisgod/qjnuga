...
module.exports = async (message) => {
    ...
    if (etiket) {
        ...
        if (message.content.includes(uye2)) {
            ...
            message.channel.send(afkembed.setDescription(`${etiket} Üyesi **${reason}** Sebebiyle \`${timeObj}\` Boyunca ekrandan uzakta.`).setColor("BLACK"))
        }
    }
